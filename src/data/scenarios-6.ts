...
/**
 * Scenarios converted from the former fixed 66-day challenge path, part 2 of
 * 2 (originally days 34–66, Acts IV–VI: Persuasion, Pressure, Mastery, plus
 * the day-67+ advanced rotation). See scenarios-5.ts for the full note on why
 * this content moved here and what changed in the conversion.
 */
export const SCENARIOS_6: Scenario[] = [
  {
    id: "per-sell-what-you-love",
    category: "persuasion",
  ...
  {
    id: "biz-two-minute-pitch",
    category: "business",
    title: { en: "The complete pitch", de: "Der vollständige Pitch" },
    prompt: {
      en: "Deliver a complete two-minute pitch for an idea you'd actually pursue: hook, problem, solution, proof, ask.",
      de: "Halte einen kompletten Zwei-Minuten-Pitch für eine Idee, die du wirklich verfolgen würdest: Haken, Problem, Lösung, Beleg, Bitte.",
    },
    difficulty: 2,
    targetSec: [100, 140],
  },
  {
    id: "deb-no-notes-no-mercy",
    category: "debate",
  ...
  {
    id: "diff-defend-unpopular-decision",
    category: "difficult",
  ...
  },
  {
    id: "deb-the-gauntlet",
    category: "debate",
    title: { en: "The gauntlet", de: "Der Spießrutenlauf" },
    prompt: {
  ...
  },
  {
    ...
    prompt: {
      en: "Deliver a eulogy for a fictional mentor who shaped you. Dignity, one specific story, one laugh through tears, one line of farewell. The hardest form there is.",
      de: "Halte eine Trauerrede für einen fiktiven Mentor, der dich geprägt hat. Würde, eine konkrete Geschichte, ein Lachen unter Tränen, ein Abschiedssatz. Die schwerste Form überhaupt.",
    },
    difficulty: 3,
    targetSec: [100, 160],
  },
  ...
  {
    id: "deb-defend-the-indefensible",
    category: "debate",
  ...
  {
    id: "ted-day-66-keynote",
    category: "ted",
    title: { en: "The keynote", de: "Die Keynote" },
    prompt: {
      en: "The graduation stage is yours. Deliver the opening of a keynote on the one idea your practice has proven to you — about speaking, discipline, or becoming. Open cold, story in the middle, land on stone.",
      de: "Die Bühne gehört dir. Halte die Eröffnung einer Keynote über die eine Idee, die dir dein Training bewiesen hat — über das Reden, die Disziplin oder das Werden. Kalter Einstieg, Geschichte in der Mitte, Landung in Stein.",
    },
    difficulty: 3,
    targetSec: [110, 170],
  },
  {
    id: "ted-the-second-keynote",
    category: "ted",
  ...
  {
    id: "diff-the-impossible-question",
    category: "difficult",
  ...
  {
    id: "story-one-minute-no-adjectives",
